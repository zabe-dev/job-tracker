...
- [2026-09-19T18:16+08:00] [CODE] Added Codex LB hosted web-search fallback for Docker sandbox failures; commit `633e72f` pushed and deployed. Search now reaches codex-lb, but live verification returned `502` because codex-lb logs show its only upstream account rate-limited for 300 seconds/no available accounts.
